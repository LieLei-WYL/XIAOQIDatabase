...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('13513382833', '123', 'avatar3.jpg', '休息休息一下', 'woman', '1999-09-15', '石家庄', '谢谢你的关注', 'infobg.jpg', '陈情令、分享、休息、休息、休息、休息、分享、休息、发现、休息、分享、分享、休息、分享、分享');
